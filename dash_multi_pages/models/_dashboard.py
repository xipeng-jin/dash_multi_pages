...
import dash_multi_pages
from dash_multi_pages._constants import MODULE_PAGE_404, STATIC_URL_PREFIX
# from dash_multi_pages.actions._action_loop._action_loop import ActionLoop
from dash_multi_pages.models import Navigation, MultiPagesBaseModel
from dash_multi_pages.models._models_utils import _log_call
from dash_multi_pages.models._navigation._navigation_utils import _NavBuildType

if TYPE_CHECKING:
    from dash_multi_pages.models import Page
    from dash_multi_pages.models._page import _PageBuildType
...
class Dashboard(MultiPagesBaseModel):
    ...
    def build(self):
        ...
        left_side_div_present = len(self.pages) > 1
        ...
        return html.Div(
            ...
            children=[
                html.Div(dash_multi_pages.__version__, id="dash_multi_pages_version", hidden=True),
    ...
    def _get_page_divs(self, page: Page) -> _PageDivsType:
        ...
        # )
        return html.Div(
            [dashboard_title, settings, page_title, nav_bar, nav_panel, page_components, logo]
        )
    ...
    def _arrange_page_divs(self, page_divs: _PageDivsType):
        ...
        left_main_divs = [page_divs["nav-panel"]]
