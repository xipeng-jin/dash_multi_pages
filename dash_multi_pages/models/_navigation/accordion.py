...
from dash_multi_pages._constants import ACCORDION_DEFAULT_TITLE
from dash_multi_pages.managers._model_manager import ModelID, model_manager
from dash_multi_pages.models import MultiPagesBaseModel
from dash_multi_pages.models._models_utils import _log_call
from dash_multi_pages.models._navigation._navigation_utils import _validate_pages


class Accordion(MultiPagesBaseModel):
    """Accordion to be used as nav_selector in [`Navigation`][dash_multi_pages.models.Navigation].
