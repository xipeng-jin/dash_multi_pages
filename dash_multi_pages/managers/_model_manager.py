"""The model manager handles access to all `MultiPagesBaseModel` instances used in a Vizro app."""
...
from dash_multi_pages.managers._managers_utils import _state_modifier
...
Model = TypeVar("Model", bound="MultiPagesBaseModel")
...
class ModelManager:
    def __init__(self):
        self.__models: Dict[ModelID, MultiPagesBaseModel] = {}
    ...
    def __getitem__(self, model_id: ModelID) -> MultiPagesBaseModel:
    ...
    # def _get_action_trigger(self, action_id: ModelID) -> MultiPagesBaseModel:  # type: ignore[return]
